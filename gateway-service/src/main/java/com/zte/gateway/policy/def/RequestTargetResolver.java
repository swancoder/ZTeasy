 ...
 * {@link com.zte.gateway.inventory.InventoryRouteDefinitionLocator}'s
 * {@code /api/v1/{name}/**} route convention (ADR-017; formerly
 * {@code GatewayRouteConfig}'s hardcoded route path prefixes). Shared by
 * {@code ZteAuthorizationFilter} and {@code ServiceToServiceAuthorizationFilter}
 * so both resolve "target service" identically.
 */
