...
public record InventoryEntry(
    ...
    public static InventoryEntry pending(String name, TargetType targetType, String baseUrl, String managementUrl) {
        return new InventoryEntry(null, name, targetType, baseUrl, managementUrl, InventoryStatus.PENDING, null);
    }
}
